...
- `internal/shared` owns shared domain, configuration, runner, run-state, workdir (codebase detection, default branches), and session facade code that is independent of any UI.
